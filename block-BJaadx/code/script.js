...
let allInput = document.querySelectorAll('input[type="password"]');
...
console.log(`The count of all Buttons is ${document.querySelectorAll(`input[type="submit"]`).length}`)
// 18. Select all the `label` element and log the count.
console.log(`The count of all Labels is ${document.querySelectorAll(`label`).length}`)
