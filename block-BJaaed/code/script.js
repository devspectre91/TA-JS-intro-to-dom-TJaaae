...
//  <ul class="flex-c flex-30">
//           <li><img src="https://eloquentjavascript.net/img/cover.jpg" alt="book"></li>
//           <li> <h2> Eloquent JavaScript, Second Edition</h2></li>
//           <li><p> Author :Marijn Haverbeke</p></li>
//           <li><a class="btn" href="">Buy Now</a></li>
//         </ul>
let myContainer = document.querySelector(".container");
bookList.books.forEach(obj => {
    let myList = document.createElement("ul");
    myList.classList.add("flex-c", "flex-30");
    let myitem1 = document.createElement("li");
    let image = document.createElement("img");
    image.src = obj.image;
    image.setAttribute("alt", "book");
    myitem1.append(image);
    let myitem2 = document.createElement("li");
    let h2 = document.createElement("h2");
    h2.innerText = obj.title;
    myitem2.append(h2);
    let myitem3 = document.createElement("li");
    let p = document.createElement("p");
    h2.innerText = `Author: ${obj.author}`;
    myitem3.append(p);
    let myitem4 = document.createElement("li");
    let a = document.createElement("a");
    a.innerText = "buy now";
    a.classList.add("btn");
    a.setAttribute("href", "");
    myitem4.append(a);
    myList.append(myitem1, myitem2, myitem3, myitem4);
    myContainer.append(myList);
})