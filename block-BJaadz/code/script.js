...
[...document.querySelectorAll(".image")].forEach(e => e.style.border = "2px solid purple");
...
[...document.querySelector(`.one`).children].forEach(e => e.remove());
...
para2.innerText = `"Append inserts as last child" just after hr element.`
...
let myArray = [...document.querySelectorAll('.box')];
for (let i = 0; i < myArray.length; i++) {
  if (i % 2 == 0) {
    myArray[i].style.backgroundColor = "aliceblue";
  }
}
...
[...document.querySelector(`.seven`).children].forEach(e => e.remove());
